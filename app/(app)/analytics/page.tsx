            ...
            <div className={styles.card} style={{ position: 'relative' }}>
              ...
              <div className={styles.lineChartArea} style={{ position: 'relative' }}>
                ...
                >
                  ...
                  {/* Curve 1: Sent (Upper curve) - Smooth 1.5s path draw */}
                  <path 
                    ...
                    style={{
                      ...
                      strokeDashoffset: 0,
                      animation: 'linePathDraw 1.5s cubic-bezier(0.32, 0.72, 0, 1) both',
                    }}
                  />

                  {/* Curve 2: Collected (Lower curve) - Smooth 1.5s path draw */}
                  <path 
                    ...
                    style={{
                      strokeDasharray: 1200,
                      strokeDashoffset: 0,
                      animation: 'linePathDraw 1.5s cubic-bezier(0.32, 0.72, 0, 1) 0.2s both',
                    }}
                  />
          ...
          <div className={styles.col4}>
            <div className={styles.card} style={{ position: 'relative' }}>
              ...
              <div className={styles.donutArea} style={{ position: 'relative' }}>
                ...
                <svg className={styles.donutSvg} viewBox="0 0 160 160" style={{ animation: 'donutScaleEntrance 1.5s cubic-bezier(0.32, 0.72, 0, 1) both', transformOrigin: 'center' }}>
                  <circle
                    cx="80"
                    cy="80"
                    r="60"
