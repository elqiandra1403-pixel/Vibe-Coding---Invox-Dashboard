...
const INITIAL_INVOICES: Invoice[] = [
  { id: 'INV-2026-0200', customer: 'Sable & Co.', issued: 'Aug 04', due: 'Aug 18', amount: '$1,200.00', numericAmount: 1200, currency: 'USD', status: 'Paid', statusClass: 'statusPaid' },
  { id: 'INV-2026-0199', customer: 'Northwind Studio', issued: 'Aug 03', due: 'Aug 17', amount: '$2,171.00', numericAmount: 2171, currency: 'USD', status: 'Pending', statusClass: 'statusPending' },
  { id: 'INV-2026-0198', customer: 'Halcyon Labs', issued: 'Aug 02', due: 'Aug 16', amount: '$3,142.00', numericAmount: 3142, currency: 'USD', status: 'Overdue', statusClass: 'statusOverdue' },
  { id: 'INV-2026-0197', customer: 'Aperture Films', issued: 'Aug 01', due: 'Aug 15', amount: '$4,113.00', numericAmount: 4113, currency: 'USD', status: 'Draft', statusClass: 'statusDraft' },
  { id: 'INV-2026-0196', customer: 'Meridian Group', issued: 'Jul 31', due: 'Aug 14', amount: '$5,084.00', numericAmount: 5084, currency: 'USD', status: 'Paid', statusClass: 'statusPaid' },
  { id: 'INV-2026-0195', customer: 'Cove Hospitality', issued: 'Jul 30', due: 'Aug 13', amount: '$6,055.00', numericAmount: 6055, currency: 'USD', status: 'Paid', statusClass: 'statusPaid' },
  { id: 'INV-2026-0194', customer: 'Palette Studio', issued: 'Jul 29', due: 'Aug 12', amount: '$7,026.00', numericAmount: 7026, currency: 'USD', status: 'Paid', statusClass: 'statusPaid' },
];

export const useDashboardStore = create<DashboardStore>((set) => ({
  metrics: INITIAL_METRICS,
  revenueTotal: '$844,400',
  numericRevenueTotal: 844400,
  currency: 'USD',
    ...
    try {
      ...
      if (fetchedInvoices && fetchedInvoices.length > 0) {
        const mappedInvoices: Invoice[] = fetchedInvoices.map((inv: any) => ({
          ...
          numericAmount: Number(inv.amount || 0),
      ...
      if (analyticsData && Array.isArray(analyticsData)) {
        ...
        if (total > 0) {
          set({ 
            numericRevenueTotal: total,
            revenueTotal: `$${total.toLocaleString('en-US')}` 
          });
        }
      }
    } catch (err: any) {
